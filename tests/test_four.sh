...
../venv/bin/python ../run_worker.py $worker_port $balancer_addr $balancer_port &
sleep 3
...
do
	...
	../venv/bin/python ../client/producer.py $balancer_addr $balancer_port $i &
done
...
do
	...
	../venv/bin/python ../client/consumer.py $balancer_addr $balancer_port $i &
	sleep 3
done
